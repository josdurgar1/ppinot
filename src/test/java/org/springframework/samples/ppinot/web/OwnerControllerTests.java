...
import org.springframework.samples.ppinot.configuration.SecurityConfiguration;
import org.springframework.samples.ppinot.model.Owner;
import org.springframework.samples.ppinot.service.AuthoritiesService;
...
class OwnerControllerTests {
	...
	void setup() {
		...
		given(this.clinicService.findOwnerById(TEST_OWNER_ID).get()).willReturn(george);
